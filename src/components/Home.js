  ...
  return (
    <div className="home">
      <div className="about">
        ...
        <p>
        Hello,  am Artyom, and I am Front End developer specializing in both front-end and back-end programming. My goal is to create efficient, user-friendly, and visually appealing websites and applications that best meet user requirements.
